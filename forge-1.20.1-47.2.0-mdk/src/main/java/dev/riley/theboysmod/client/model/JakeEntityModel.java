...
import dev.riley.theboysmod.client.animation.JakeEntityAnimation;
...
public class JakeEntityModel extends HierarchicalModel<JakeEntity> {
    ...
    private final JakeEntityModel.ModelParts parts;


    public JakeEntityModel(ModelPart root) {
        ...
        this.parts = new JakeEntityModel.ModelParts(body, head);
    }
    ...
    @Override
    public void setupAnim(@NotNull JakeEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        root().getAllParts().forEach(ModelPart::resetPose);
        animate(entity.idleAnimationState, JakeEntityAnimation.IDLE, ageInTicks);
        // animate(entity.attackAnimationState, ExampleAnimatedEntityAnimation.ATTACK, ageInTicks);
        // etc...

        if(!entity.isInWaterOrBubble()) {
            animateWalk(JakeEntityAnimation.WALKING, limbSwing, limbSwingAmount, 1.0F, 2.5F);
        } else {
            // TODO: Swim animation
        }
    }
