...
public class CarterEntityModel extends HierarchicalModel<CarterEntity> {
    // This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(TheBoysMod.MODID, "carter_entity"), "main");


    private final CarterEntityModel.ModelParts parts;
    ...
    public CarterEntityModel(ModelPart root) {
        ...
        this.parts = new CarterEntityModel.ModelParts(body, head);
    }
    ...
    public void setupAnim(@NotNull CarterEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        if(!entity.isInWaterOrBubble()) {
            animateWalk(CarterEntityAnimation.WALKING, limbSwing, limbSwingAmount, 1.0F, 2.5F);
        } else {
            // TODO: Swim animation
        }
    }
