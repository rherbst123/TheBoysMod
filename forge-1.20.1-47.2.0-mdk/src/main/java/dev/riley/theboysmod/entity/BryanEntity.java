...
public class BryanEntity extends Animal {
    public final AnimationState idleAnimationState = new AnimationState();

    public BryanEntity(EntityType<? extends Animal> type, Level level) {
        super(type, level);
    }

    public BryanEntity(Level level, double x, double y, double z) {
        this(EntityInit.BRYAN_ENTITY.get(), level);
        setPos(x, y, z);
    }

    public BryanEntity(Level level, BlockPos pos) {
    ...
    public AgeableMob getBreedOffspring(@NotNull ServerLevel level, @NotNull AgeableMob otherParent) {
        BryanEntity entity = new BryanEntity(level, getX(), getY(), getZ());
    ...
    public static boolean canSpawn(EntityType<BryanEntity> tEntityType, ServerLevelAccessor serverLevelAccessor, MobSpawnType spawnType, BlockPos blockPos, RandomSource randomSource) {
