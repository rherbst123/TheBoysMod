...
public class EvanEntity extends Animal {
    ...
    public EvanEntity(EntityType<? extends Animal> type, Level level) {
        super(type, level);
    }

    public EvanEntity(Level level, double x, double y, double z) {
        this(EntityInit.EVAN_ENTITY.get(), level);
        setPos(x, y, z);
    }

    public EvanEntity(Level level, BlockPos pos) {
    ...
    public AgeableMob getBreedOffspring(@NotNull ServerLevel level, @NotNull AgeableMob otherParent) {
        EvanEntity entity = new EvanEntity(level, getX(), getY(), getZ());
    ...
    public static boolean canSpawn(EntityType<EvanEntity> tEntityType, ServerLevelAccessor serverLevelAccessor, MobSpawnType spawnType, BlockPos blockPos, RandomSource randomSource) {
