...
public class JohnEntity extends Animal {
    public final AnimationState idleAnimationState = new AnimationState();

    public JohnEntity(EntityType<? extends Animal> type, Level level) {
        super(type, level);
    }

    public JohnEntity(Level level, double x, double y, double z) {
        this(EntityInit.JOHN_ENTITY.get(), level);
        setPos(x, y, z);
    }

    public JohnEntity(Level level, BlockPos pos) {
    ...
    public AgeableMob getBreedOffspring(@NotNull ServerLevel level, @NotNull AgeableMob otherParent) {
        JohnEntity entity = new JohnEntity(level, getX(), getY(), getZ());
    ...
    public static boolean canSpawn(EntityType<JohnEntity> tEntityType, ServerLevelAccessor serverLevelAccessor, MobSpawnType spawnType, BlockPos blockPos, RandomSource randomSource) {
