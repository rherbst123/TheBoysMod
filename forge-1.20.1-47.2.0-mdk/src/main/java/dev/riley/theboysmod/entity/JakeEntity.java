...
public class JakeEntity extends Animal {
    public final AnimationState idleAnimationState = new AnimationState();

    public JakeEntity(EntityType<? extends Animal> type, Level level) {
        super(type, level);
    }

    public JakeEntity(Level level, double x, double y, double z) {
        this(EntityInit.JAKE_ENTITY.get(), level);
        setPos(x, y, z);
    }

    public JakeEntity(Level level, BlockPos pos) {
    ...
    public AgeableMob getBreedOffspring(@NotNull ServerLevel level, @NotNull AgeableMob otherParent) {
        JakeEntity entity = new JakeEntity(level, getX(), getY(), getZ());
    ...
    public static boolean canSpawn(EntityType<JakeEntity> tEntityType, ServerLevelAccessor serverLevelAccessor, MobSpawnType spawnType, BlockPos blockPos, RandomSource randomSource) {
