...
public class JacobEntity extends Animal {
    public final AnimationState idleAnimationState = new AnimationState();

    public JacobEntity(EntityType<? extends Animal> type, Level level) {
        super(type, level);
    }

    public JacobEntity(Level level, double x, double y, double z) {
        this(EntityInit.JACOB_ENTITY.get(), level);
        setPos(x, y, z);
    }

    public JacobEntity(Level level, BlockPos pos) {
    ...
    public AgeableMob getBreedOffspring(@NotNull ServerLevel level, @NotNull AgeableMob otherParent) {
        JacobEntity entity = new JacobEntity(level, getX(), getY(), getZ());
    ...
    public static boolean canSpawn(EntityType<JacobEntity> tEntityType, ServerLevelAccessor serverLevelAccessor, MobSpawnType spawnType, BlockPos blockPos, RandomSource randomSource) {
