...
public class NickEntity extends Animal {
    public final AnimationState idleAnimationState = new AnimationState();

    public NickEntity(EntityType<? extends Animal> type, Level level) {
        super(type, level);
    }

    public NickEntity(Level level, double x, double y, double z) {
        this(EntityInit.NICK_ENTITY.get(), level);
        setPos(x, y, z);
    }

    public NickEntity(Level level, BlockPos pos) {
    ...
    public AgeableMob getBreedOffspring(@NotNull ServerLevel level, @NotNull AgeableMob otherParent) {
        NickEntity entity = new NickEntity(level, getX(), getY(), getZ());
    ...
    public static boolean canSpawn(EntityType<NickEntity> tEntityType, ServerLevelAccessor serverLevelAccessor, MobSpawnType spawnType, BlockPos blockPos, RandomSource randomSource) {
